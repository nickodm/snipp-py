...
def validate(data, custom_formats={}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object", value=data, name="" + (name_prefix or "data") + "", definition={'$schema': 'https://json-schema.org/draft-07/schema', 'title': 'Snippet Metadata Schema', 'type': 'object', 'additionalProperties': False, 'required': ['snippet-info', 'software-info'], 'properties': {'snippet-info': {'type': 'object', 'additionalProperties': False, 'required': ['name', 'id'], 'properties': {'name': {'type': 'string'}, 'id': {'type': 'string'}, 'description': {'type': 'string'}, 'git_init': {'type': 'boolean', 'default': False}, 'creation_date': {'type': 'integer'}}}, 'software-info': {'type': 'object', 'additionalProperties': False, 'required': ['version'], 'properties': {'version': {'type': 'array', 'minItems': 3, 'maxItems': 5, 'required': ['Major', 'Minor', 'Patch', 'Stage', 'Stage Number'], 'prefixItems': [{'name': 'Major', 'type': 'integer'}, {'name': 'Minor', 'type': 'integer'}, {'name': 'Patch', 'type': 'integer'}, {'name': 'Stage', 'enum': ['alpha', 'beta', 'rc', 'final']}, {'name': 'Stage Number', 'type': 'integer'}]}}}}}, rule='type')
            ...
            if data__snippetinfo_is_dict:
                ...
                if "id" in data__snippetinfo_keys:
                    ...
                    if not isinstance(data__snippetinfo__id, (str)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".snippet-info.id must be string", value=data__snippetinfo__id, name="" + (name_prefix or "data") + ".snippet-info.id", definition={'type': 'string'}, rule='type')
                ...
                if data__snippetinfo_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".snippet-info must not contain "+str(data__snippetinfo_keys)+" properties", value=data__snippetinfo, name="" + (name_prefix or "data") + ".snippet-info", definition={'type': 'object', 'additionalProperties': False, 'required': ['name', 'id'], 'properties': {'name': {'type': 'string'}, 'id': {'type': 'string'}, 'description': {'type': 'string'}, 'git_init': {'type': 'boolean', 'default': False}, 'creation_date': {'type': 'integer'}}}, rule='additionalProperties')
